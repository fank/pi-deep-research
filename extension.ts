/**
 * Deep Research Checkpoint — lightweight extension providing only the
 * research_checkpoint tool. The web_search and fetch_content tools are
 * now provided by pi-web-access (npm:pi-web-access).
 */
